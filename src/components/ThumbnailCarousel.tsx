...
export function ThumbnailCarousel() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden flex flex-col gap-6 md:gap-10 select-none">
        {/* Cinematic gradient fade on side limits */}
          ...
          <div className="flex gap-6 md:gap-8 w-max animate-[scroll-right_50s_linear_infinite] hover:[animation-play-state:paused] will-change-transform opacity-100">
            {[...THUMBNAILS.slice(0, 5), ...THUMBNAILS.slice(0, 5), ...THUMBNAILS.slice(0, 5)].map((src, idx) => (
              <motion.div
                ...
                className="relative w-[320px] h-[180px] md:w-[500px] md:h-[281px] rounded-2xl overflow-hidden shadow-[0_0_35px_rgba(255,43,43,0.1)] liquid-glass-strong group flex-shrink-0 cursor-pointer"
              >
                <img
                  src={src}

  ...
  return (
    <section className="py-32 relative z-10">
      <div className="max-w-5xl mx-auto px-4 md:px-6 relative">
        ...
        {/* Glow backdrop */}
        <div className="absolute inset-0 bg-primary/10 blur-[100px] rounded-[100px] pointer-events-none" />
        ...
        <div className="liquid-glass-strong rounded-[2.5rem] p-8 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <motion.button
              ...
              className="group relative inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-white liquid-glass-btn rounded-full overflow-hidden active:scale-95"
            >

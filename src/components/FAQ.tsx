              ...
              <div key={idx}>
                <FadeInSection delay={idx * 0.07}>
                  <div
                    ...
                    ${isOpen
                        ? 'liquid-glass-strong border-l-2 border-primary shadow-[0_0_30px_var(--primary-glow)]'
                        : 'liquid-glass-standard hover:shadow-[0_0_20px_var(--primary-glow)]'
                      }`}
                    onClick={() => toggle(idx)}
                    role="button"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between px-6 py-5 gap-4">
                      <h3
                        className={`font-display font-semibold text-base md:text-lg transition-colors duration-200 ${isOpen ? 'text-text-main' : 'text-text-main group-hover:text-text-main'
                          }`}
                      >
                        {item.question}
                      </h3>
                      ...
                      <motion.div
                        ...
                        className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center border transition-colors duration-200 ${isOpen
                            ? 'border-primary bg-primary/20 text-primary'
                            : 'border-text-main/10 bg-text-main/5 text-text-muted group-hover:border-primary/50 group-hover:text-primary'
                          }`}
                      >
